...
\begin{document}
    ...
    \xjtucontent
        ...
        % 第一章
        \input{pages/EEGAcqusitionDesign}

        % 第二章
        \input{pages/EEGProcessingControlDesign}

        % 第三章
        \input{pages/EEGJointSystem}

        \input{pages/EEGHostProgram}

        \input{pages/EEGSystemHardwarePerformance}

        \input{pages/EEGDesignProblemSolution}
